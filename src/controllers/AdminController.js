...
//                 dailySignups,
//                 // Daily active usage by lastUsageDate (last activity day count)
//                 dailyUsage,
...
//                 // Daily usage by lastUsageDate (only where not null); limit to 30 most recent days
//                 User.aggregate([
//                     { $match: { lastUsageDate: { $ne: null } } },
//                     {
//                         $group: {
//                             _id: {
//                                 $dateToString: { format: "%Y-%m-%d", date: "$lastUsageDate" },
//                             },
//                             count: { $sum: 1 },
//                         },
//                     },
